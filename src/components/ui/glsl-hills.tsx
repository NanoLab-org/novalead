...
/**
 * Animated GLSL "hills" background (three.js). Client-only island — it owns
 * a <canvas> that fills its parent and animates via requestAnimationFrame.
 * Sizes to its container (not the window), so it can back any section.
 */
