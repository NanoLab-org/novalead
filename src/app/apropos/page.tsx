...
export default function AProposPage() {
  return (
    <main className="min-h-screen bg-base">
      ...
      {/* Hero */}
      <section className="px-10 pt-36 pb-20 border-b border-white/10 text-center max-w-4xl mx-auto">
      ...
      {/* Mission & Vision */}
      <section className="px-10 py-24 border-b border-white/10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-surface border border-white/10 rounded-xl p-6">
              ...
              <h3 className="text-white font-bold text-sm mb-1">{member.nom}</h3>
