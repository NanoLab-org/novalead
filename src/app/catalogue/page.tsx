  ...
  return (
    <div className="group flex flex-col gap-3 bg-surface p-[22px] min-[900px]:py-7 min-[900px]:px-[30px] cursor-pointer transition-colors duration-200 hover:bg-surface-hover">
      ...
      <div className="flex justify-between items-center mt-1 pt-3.5 border-t border-white/5">
        ...
        <button className="px-4 py-2 bg-transparent text-orange border border-orange/30 rounded-lg text-[12.5px] font-semibold cursor-pointer transition-colors duration-200 hover:bg-orange/10 hover:border-orange/60">
          Voir la formation
        </button>
      </div>
    </div>
