...
export default function Navbar() {
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl flex items-center justify-between px-8 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-md shadow-lg">
      ...
      <ul className="hidden md:flex gap-8 text-sm font-medium text-[#7a96aa]">
      ...
      <button className="bg-[#f97316] text-white text-sm font-semibold px-5 py-2 rounded-full hover:opacity-90 transition-opacity">
        Nous contacter
      </button>
    </nav>
  );
